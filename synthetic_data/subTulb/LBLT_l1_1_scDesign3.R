...
colnames(l1_1) <- colData(l1_1)$cell_id
...
zellkonverter::writeH5AD(simu_sce, "V1_simu_sce_subTulb.h5ad")
...
ggsave("LBLT_larger_plot_l1_1.png", plot, width = 15, height = 10, units = "in", dpi = 300)
