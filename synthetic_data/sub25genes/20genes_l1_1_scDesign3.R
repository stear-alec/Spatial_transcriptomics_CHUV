...
h5ad_file <- "/work/PRTNR/CHUV/DIR/rgottar1/spatial/env/astear/Programming/synthetic_data/20genes/chuvio_L1_1_20genes.h5ad"
...
ggsave("20genes_larger_plot_l1_1.png", plot, width = 15, height = 10, units = "in", dpi = 300)
