...
chuvio_L4_1.raw = chuvio_L4_1

#Copying, not sure this step is necessary
chuvio_L4_1_dis500 = chuvio_L4_1.copy()
...
ct.tl.spatial_communication(chuvio_L4_1_dis500,
    database_name='cellchat', df_ligrec=df_cellchat, dis_thr=500, heteromeric=True, pathway_sum=True)
chuvio_L4_1_dis500.write("data/chuvio_L4_1_dis500.h5ad")
