...
tensor = c2c.io.read_data.load_tensor(os.path.join(output_folder, 'BALF-Tensor-5chuvio-VISTA_17_04_24.pkl'))
meta_tensor = c2c.io.load_variable_with_pickle(os.path.join(output_folder, 'BALF-Tensor-5chuvio-VISTA-Metadata_17_04_24.pkl'))
...
c2c.io.export_variable_with_pickle(tensor2, output_folder + '/BALF-Tensor-5chuvio-VISTAOut_17_04_24.pkl')