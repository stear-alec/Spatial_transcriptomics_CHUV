...
tensor = c2c.io.read_data.load_tensor(os.path.join(output_folder, 'BALF-Tensor-5chuvio-VISTA.pkl'))
meta_tensor = c2c.io.load_variable_with_pickle(os.path.join(output_folder, 'BALF-Tensor-5chuvio-VISTA-Metadata.pkl'))
...
c2c.io.export_variable_with_pickle(tensor2, output_folder + '/BALF-Tensor-5chuvio-VISTAOut.pkl')